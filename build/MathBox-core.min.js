var \u03c0=Math.PI,\u03c4=2*\u03c0;(function(a){for(var b in a)if(!window[b])throw"Error: MathBox requires "+a[b];})({THREE:"Three.js",tQuery:"tQuery.js (bundle)",ThreeBox:"ThreeBox.js",ThreeRTT:"ThreeRTT.js"});window.MathBox={};window.mathBox=function(a,b){a&&!(a instanceof Node)&&(b=a,a=null);return tQuery.createWorld(b).mathBox(a,b)};MathBox.getShader=function(a){var b=document.getElementById(a);return b&&b.innerText||a};Math.sign=function(a){return 0<a?1:0>a?-1:0};MathBox.Attributes=function(){};
MathBox.Attributes.prototype={get:function(a){return void 0===a?this.__attributes||{}:!this.__attributes?void 0:this.__attributes[a]},set:function(a,b){function c(a,b){try{var c=b;if(void 0===f[a]){var k="validate"+a.charAt(0).toUpperCase()+a.slice(1);f[a]=h[k]||!1}b=f[a]?f[a](c):c;d[a]=b;g[a]=b}catch(l){throw"Exception setting '"+a+"' to '"+b+"': "+l;}}this.__attributes||(this.__attributes={});this.__validators||(this.__validators={});var d={},f=this.__validators,g=this.__attributes,h=this;void 0===
...
MathBox.Animator.prototype={finalState:function(a){var b=_.extend({},a.get());a.__queue&&_.each(a.__queue,function(a,d){_.each(a,function(a){a.to&&(b[d]=a.to)})});return b},attach:function(a){if(!a.__queue){if(!a.__attributes)throw"Cannot attach to object without attributes";var b=this,c=a.set;a.set=function(a,f,g){if(!g){g=a;if(void 0===a||null===a)return;a.constructor==String&&(g={},g[a]=f);b.stop(this,g)}c.call(this,a,f)};a.__queue={};a.__animations=0}},hurry:function(a,b,c){c=c||300;_.each(b||
a.__queue,function(b,f){_.each(a.__queue[f],function(a){a instanceof MathBox.Animator.Delay&&(a.duration=0);a instanceof MathBox.Animator.Animation&&(a.duration=Math.min(a.duration,c))})}.bind(this))},stop:function(a,b){_.each(b||a.__queue,function(b,d){for(;a.__queue[d];)this.dequeue(a,d,!0)}.bind(this))},animate:function(a,b,c){c=_.extend({duration:300},c||{});this.attach(a);_.each(b,function(b,f){var g=a.__queue[f]=a.__queue[f]||[];if(c.delay){var h=new MathBox.Animator.Delay(a,f,c.delay);g.push(h);
0==a.__animations++&&this.active.push(a)}a.__validators[f]&&(b=a.__validators[f](b));h=new MathBox.Animator.Animation(a,f,b,c.duration,c.callback,c.ease);g.push(h);0==a.__animations++&&this.active.push(a)}.bind(this))},dequeue:function(a,b,c){var d=a.__queue[b];if(d){var f=d.shift();0==d.length&&delete a.__queue[b];c&&f.skip();0==--a.__animations&&this.active.splice(this.active.indexOf(a),1)}},update:function(){_.each(this.active,function(a){_.each(a.__queue,function c(d,f){var g=d[0];value=g.apply();
g.done()&&(this.dequeue(a,f),d[0]&&c.call(this,d,f))}.bind(this))}.bind(this))}};MathBox.Animator.Delay=function(a,b,c){this.object=a;this.key=b;this.duration=c;this.fraction=this.start=0};MathBox.Animator.Delay.prototype={init:function(){this.start=+new Date},apply:function(){this.start||this.init();this.fraction=0<this.duration?Math.min(1,(+new Date-this.start)/this.duration):1},skip:function(){this.duration=0},done:function(){return 1==this.fraction}};
MathBox.Animator.Animation=function(a,b,c,d,f,g){this.object=a;this.key=b;this.from=null;this.to=c;this.duration=d;this.fraction=this.start=0;this.callback=f;this.ease=g};
MathBox.Animator.Animation.prototype={init:function(){this.start=+new Date;null===this.from&&(this.from=this.object.get(this.key));void 0===this.from&&(this.from=0)},apply:function(){function a(c,d){void 0===d&&(d=c);if(d===c)return c;if(typeof c!=typeof d)throw console.log(b,f),"Data type mismatch between from/to values in animator. "+f+": "+c+" ("+c.constructor+"), "+d+"("+d.constructor+")";var g;switch(typeof d){default:case "string":throw"Unimplemented value type in animator. ("+typeof d+")";
case "function":return function(){return a(c.apply(this,arguments),d.apply(this,arguments))};case "boolean":return 0.5<h?d:c;case "number":return c+(d-c)*e;case "object":if(d.constructor==Array)return g=[],_.loop(c.length,function(b){g[b]=a(c[b],d[b])}),g;if(d.constructor==THREE.Matrix4){g=new THREE.Matrix4;for(var l=0;16>l;++l)g.elements[l]=c.elements[l]+(d.elements[l]-c.elements[l])*e;return g}if(d.constructor==THREE.Vector3)return g=new THREE.Vector3,g.x=c.x+(d.x-c.x)*e,g.y=c.y+(d.y-c.y)*e,g.z=
c.z+(d.z-c.z)*e,g;if(d.constructor==THREE.Color)return g=new THREE.Color,g.r=c.r+(d.r-c.r)*e,g.g=c.g+(d.g-c.g)*e,g.b=c.b+(d.b-c.b)*e,g;throw"Unimplemented value type in animator. "+typeof d+" ("+d.constructor+")";}}this.start||this.init();var b=this.object,c=this.from,d=this.to,f=this.key,g=this.ease,h;this.fraction=h=0<this.duration?Math.min(1,(+new Date-this.start)/(this.duration||1)):1;var e;switch(g){case "in":e=1-(1-h)*(1-h);break;case "out":e=h*h;break;default:e=0.5-0.5*Math.cos(h*\u03c0)}this.object.set(this.key,
...
c;if(a==+a)return _.each(this.primitives,function(d){(b||!d.removed)&&d.get("sequence")==a&&c.push(d)}),c;var d=a.match(/^\s*#([a-zA-Z0-9_-]+)|([a-zA-Z0-9_-]+)?\s*$/);if(!d)return[];var e=d[2],i=d[1];if(i)_.each(this.primitives,function(a){(b||!a.removed)&&a.get("id")==i&&c.push(a)});else{if("camera"==e)return this.cameraProxy&&[this.cameraProxy]||[];if("viewport"==e)return[this.viewport()];e&&_.each(this.primitives,function(a){(b||!a.removed)&&a.type()==e&&c.push(a)})}return c}.bind(this),c=[],a=
...
MathBox.Ticks=function(a,b,c,d,f){var g=(b-a)/(c||10),d=d||1,c=d==\u03c0?2:10,h=d*Math.pow(c,Math.floor(Math.log(g/d)/Math.log(c))),d=_.map(c==\u03c0?[1]:[5,1,0.5],function(a){return h*a}),e=_.reduce(d,function(a,b){return Math.abs(b-g)<Math.abs(a-g)?b:a},h),f=+!f,a=(Math.ceil(a/e)+f)*e,b=(Math.floor(b/e)-f)*e,c=Math.ceil((b-a)/e)+1,i=[];_.loop(c,function(b){i.push(a+b*e)});return i};MathBox.TicksLog=function(){};
...
this.loop().hookPreRender(f);if(!b.cameraControls){var g=this.tCamera();g.position.x=0;g.position.y=0;g.position.z=b.orbit;g.lookAt(new THREE.Vector3(0,0,0))}return d});MathBox.Director=function(a,b){this._stage=a;this.script=b;this.rollback={};this.lastCommand=this.step=0};
MathBox.Director.prototype={invert:function(a){var b=this._stage,c=[],d=a[0],f=a[1],g=a[2],h=a[3];switch(d){case "add":c.push(["remove",g.sequence||MathBox.Primitive.sequence+1]);break;case "remove":targets=b.select(f);_.each(targets,function(a){c.push(["add",a.type(),b.get(a)])});break;case "animate":case "set":targets=b.select(f),_.each(targets,function(a){var f=h&&Math.min(300,h.duration)||300;c.push([d,a.singleton||a.get("sequence"),b.get(a),{duration:f}])})}return c},apply:function(a,b,c){var d=
this._stage;_.each(a,function(a){var g=a[0]||"",h=a[1]||"",e=a[2]||{},i=a[3]||{};b&&(a=this.invert(a),a=[0,0].concat(a),Array.prototype.splice.apply(b,a));c&&(i&&(i=_.extend({},i),i.delay=0,i.duration=Math.min(300,i.duration)),e&&(e=_.extend({},e),e.delay=0,e.duration=Math.min(300,e.duration)));switch(g){case "add":d.spawn(h,e,i);break;case "remove":_.each(d.select(h),function(a){d.remove(a,e)});break;case "set":var g=d.select(h),j=e.constructor==Array;_.each(g,function(a,b){a.set(j?e[b]:e)});break;
case "animate":g=d.select(h),j=e.constructor==Array,_.each(g,function(a,b){d.animate(a,j?e[b]:e,i)})}}.bind(this));return this},insert:function(a){a[0].constructor!=Array&&(a=[a]);this.script.splice(this.step,0,a);this.forward();return this},go:function(a,b){if(this.script.length){for(;0>a;)a+=this.script.length+1;for(;a>=this.script.length+1;)a-=this.script.length+1;for(;a>this.step;)this.forward(b);for(;a<this.step;)this.back(b)}},skipping:function(){var a=+new Date,b=!1;500>a-this.lastCommand&&
...
c=function(c){return new MathBox.Renderable.Mesh(d,{type:c,dynamic:a.live},b)};this.line=c("line");this.points=c("points");this.calculate()},calculate:function(){var a=this.vertices,b=this.get(),c=b.data,d=b.domain,f=b.n,g=d[0],h=(d[1]-g)/(f-1),e;_.loop(f,function(d){e=c&&void 0!==c[d]?c[d]:b.expression.call(this,g,d);e instanceof Array||(e=[g,e,0]);e=e.concat([0,0,0]);a[d].set.apply(a[d],e);g+=h}.bind(this))}});MathBox.Primitive.types.curve=MathBox.Curve;
MathBox.Bezier=function(a){MathBox.Curve.call(this,a)};
MathBox.Bezier.prototype=_.extend(new MathBox.Curve(null),{defaults:function(){return{n:64,domain:[0,1],data:null,order:3,expression:function(){return 0},live:!1,points:!1,line:!0,style:{}}},type:function(){return"bezier"},calculate:function(){var a=this.vertices,b=this.get(),c=b.domain,d=b.data,f=b.order,g=b.n;if(1>f||3<f)throw"Bezier curve order must be 1, 2 or 3.";var h=[],e;_.loop(f+1,function(a){e=d&&void 0!==d[a]?d[a]:b.expression.call(this,a,a);e instanceof Array||(e=[j,e,0]);e=e.concat([0,
0,0]);h.push(new THREE.Vector3(e[0],e[1],e[2]))}.bind(this));var i={bezierPoints:h},j=c[0],k=(c[1]-j)/(g-1);_.loop(g,function(b){a[b].set(j,0,0);j+=k});c={uniforms:i,shaders:{position:function(a,b){a.snippet("bezier"+f).snippet("mathTransform");b.viewport(a)}}};this.line.set(c);this.points.set(c)}});MathBox.Primitive.types.bezier=MathBox.Bezier;MathBox.Axis=function(a){null!==a&&MathBox.Primitive.call(this,a)};
MathBox.Axis.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{axis:0,offset:[0,0,0],n:2,ticks:10,tickBase:1,arrow:!0,size:0.07,style:{lineWidth:4,color:new THREE.Color(7368816)}}},renderables:function(){return[this.line,this.ticks,this.arrow]},type:function(){return"axis"},adjust:function(a){var b=this.get(),c=b.axis,d=b.offset,f=b.arrow,g=b.ticks,h=b.tickBase,b=b.n,e=this.points,i=this.tickPoints,j=this.tickSigns,k=[0,0,0],l=new THREE.Vector3,a=a.axis(c),m=a[0],a=a[1],n=
(a-m)/(b-1);l.set.apply(l,d);_.loop(b,function(a){k[c]=m+a*n;e[a].set.apply(e[a],k);e[a].addSelf(l)});this.arrow.show(f);this.ticks.show(!!g);if(g){d=MathBox.Ticks(m,a,g,h,!0);f=Math.floor(i.length/2);d.length>f&&(d=d.slice(0,f));var f=[0,0,0],q;f[2==c?0:1-c]=0.01*(a-m);this.epsilon.set.apply(this.epsilon,f);k=[0,0,0];_.each(d,function(a,b){b*=2;k[c]=a;i[b].set.apply(i[b],k);i[b].addSelf(l);j[b]=1;i[b+1].copy(i[b]);j[b+1]=-1;q=b+1});d=q+1;for(b=i.length;d<b;)i[d].copy(i[q]),j[d]=j[q],d++}window.ij=
!0},make:function(){var a=this.get(),b=a.n,c=a.ticks,d=this.style,f=this.points=[],g=this.tickPoints=[],h=this.tickSigns=[],e=this.epsilon=new THREE.Vector3;_.loop(b,function(){f.push(new THREE.Vector3)});_.loop(8*c,function(){g.push(new THREE.Vector3);h.push(1)});c={dynamic:!0,size:a.size,offset:0.5};a={dynamic:!0,size:0.2*a.size};this.line=new MathBox.Renderable.Mesh(f,{dynamic:!0,type:"line"},d);this.arrow=new MathBox.Renderable.ArrowHead(f[b-2],f[b-1],c,d);this.ticks=new MathBox.Renderable.Ticks(g,
h,e,a,d)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
1,function(){a[g].set.apply(a[g],f);g++;f[c.axis]+=c.inv;a[g].set.apply(a[g],f);g++})});d=Math.max(0,g-1);for(h=a.length;g<h;)a[g++].copy(a[d])}var c=this.get(),d=c.axis,f=c.ticks,g=c.tickBase,h=c.n,e=c.show,i=c.offset,c=this.points,j=this.limit,k=[];"number"==typeof h&&(h=[h,h]);_.each(d,function(b,c){var d=a.axis(b);k.push({axis:b,min:d[0],max:d[1],inv:(d[1]-d[0])/(h[c]-1),ticks:f[c],tickBase:g[c]})});this.lines[0].show(e[0]);this.lines[1].show(e[1]);e[0]&&b(c[0],k[1],k[0],j[0],h[0]);e[1]&&b(c[1],
k[0],k[1],j[1],h[1])},make:function(){var a=this.get(),b=a.ticks,c=a.n,d=this.points=[[],[]],a=this.style;"number"==typeof c&&(c=[c,c]);var f=this.limit=[0,0];_.each(b,function(a,b){b=1-b;f[b]=4*a;_.loop(2*f[b]*(c[b]-1),function(){d[b].push(new THREE.Vector3)})});this.lines=[];this.lines.push(new MathBox.Renderable.Mesh(d[0],{type:"line",strip:!1,dynamic:!0},a));this.lines.push(new MathBox.Renderable.Mesh(d[1],{type:"line",strip:!1,dynamic:!0},a))}});MathBox.Primitive.types.grid=MathBox.Grid;
MathBox.Vector=function(a){null!==a&&(MathBox.Primitive.call(this,a),this.render=[],this.line=this.points=this.vertices=null)};
MathBox.Vector.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{n:1,data:null,expression:function(){return 0},live:!1,style:{},size:0.07}},type:function(){return"vector"},renderables:function(){return this.render},adjust:function(a){this.get();this.calculate(a)},make:function(){var a=this.get(),b=this.style,c=a.n,d=this.vertices=[],f=this.points=[],g=this.render=[],h={dynamic:a.live,type:"line",strip:!1},e={size:a.size},i=0;_.loop(c,function(){d.push(new THREE.Vector3);d.push(new THREE.Vector3);
f.push(new THREE.Vector3);f.push(new THREE.Vector3);var a=new MathBox.Renderable.ArrowHead(f[i++],f[i++],e,b);g.push(a)});this.line=new MathBox.Renderable.Mesh(d,h,b);g.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.points,d=this.get(),f=d.data,g=d.n,h=d.size,e=new THREE.Vector3(1,1,1),i=new THREE.Vector3;if(a){var j=a.transform.elements,a=h/2/Math.abs(j[0]),k=h/2/Math.abs(j[5]),h=h/2/Math.abs(j[10]);e.set(a,k,h)}var l=0,m=0;_.loop(2*g,function(a){p=f&&void 0!==
f[a]?f[a]:d.expression.call(this,m,l);p instanceof Array||(p=[a,p,0]);p=p.concat([0,0,0]);c[a].set.apply(c[a],p);b[a].set.apply(b[a],p);if(1==a%2){i.sub(b[a],b[a-1]);i.x=Math.abs(i.x);i.y=Math.abs(i.y);i.z=Math.abs(i.z);var g=i.lengthManhattan(),g=1-i.dot(e)/g/i.length();i.sub(b[a],b[a-1]);i.multiplyScalar(g);b[a].add(b[a-1],i)}m=l?m+1:m;l=(l+1)%2}.bind(this))}});MathBox.Primitive.types.vector=MathBox.Vector;MathBox.Surface=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
b=this.get(),c=b.data,d=b.domain,f=b.n;"number"==typeof f&&(f=[f,f]);var g=d[0][0],h=d[1][0],e=(d[0][1]-g)/(f[0]-1),i=(d[1][1]-h)/(f[1]-1),j,k=0;_.loop(f[1],function(l){g=d[0][0];_.loop(f[0],function(d){j=c&&void 0!==c[l]&&void 0!==c[l][d]?c[l][d]:b.expression.call(this,g,h,d,l,k);j instanceof Array||(j=[g,j,h]);j=j.concat([0,0,0]);a[k].set.apply(a[k],j);g+=e;k++}.bind(this));h+=i}.bind(this))}});MathBox.Primitive.types.surface=MathBox.Surface;
...
MathBox.BezierSurface.prototype=_.extend(new MathBox.Surface(null),{defaults:function(){return{n:[64,64],domain:[[0,1],[0,1]],data:null,order:3,expression:function(){return 0},live:!1,points:!1,line:!1,mesh:!0,doubleSided:!0,flipSided:!1,shaded:!0,style:{}}},type:function(){return"bezierSurface"},calculate:function(){var a=this.vertices,b=this.get(),c=b.domain,d=b.data,f=b.order,g=b.n;"number"==typeof g&&(g=[g,g]);if(3!=f)throw"Bezier surface order must be 3.";var h=[],e;_.loop(f+1,function(a){_.loop(f+
1,function(c){e=d&&void 0!==d[a]&&void 0!==d[a][c]?d[c]:b.expression.call(this,c,a,c,a);e instanceof Array||(e=[c,e,a]);e=e.concat([0,0,0]);h.push(e)}.bind(this))}.bind(this));e=h;this.matrixX.set(e[0][0],e[1][0],e[2][0],e[3][0],e[4][0],e[5][0],e[6][0],e[7][0],e[8][0],e[9][0],e[10][0],e[11][0],e[12][0],e[13][0],e[14][0],e[15][0]);this.matrixY.set(e[0][1],e[1][1],e[2][1],e[3][1],e[4][1],e[5][1],e[6][1],e[7][1],e[8][1],e[9][1],e[10][1],e[11][1],e[12][1],e[13][1],e[14][1],e[15][1]);this.matrixZ.set(e[0][2],
e[1][2],e[2][2],e[3][2],e[4][2],e[5][2],e[6][2],e[7][2],e[8][2],e[9][2],e[10][2],e[11][2],e[12][2],e[13][2],e[14][2],e[15][2]);var i=this.coefficients;this.matrixX.multiplySelf(i).transpose().multiplySelf(i);this.matrixY.multiplySelf(i).transpose().multiplySelf(i);this.matrixZ.multiplySelf(i).transpose().multiplySelf(i);var i={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},j=c[0][0],k=c[1][0],l=(c[0][1]-j)/(g[0]-1),m=(c[1][1]-k)/(g[1]-1),n=0;_.loop(g[1],function(){j=
c[0][0];_.loop(g[0],function(){a[n].set(j,k,0);j+=l;n++}.bind(this));k+=m}.bind(this));i={uniforms:i,shaders:{position:function(a,b){a.snippet("bezierSurface"+f).snippet("mathTransform");b.viewport(a)}}};this.mesh.set(i);this.line.set(i);this.points.set(i)}});MathBox.Primitive.types.bezierSurface=MathBox.BezierSurface;
...
b);this.transform.multiplyVector3(a)},from:function(a){var b=this._uniforms.polarAspect,c=this._uniforms.polarFocus,d=this._uniforms.polarAlpha,f=this._uniforms.polarPower;this.inverse.multiplyVector3(a);if(1E-4<d){var g=a.x,h=a.y*b+c,e=Math.sqrt(g*g+h*h);theta=Math.atan2(h,g);a.x=theta/d;a.y=(e-c)/b}a.x/=options.fold;a.y=Math.sign(a.y)*Math.pow(Math.abs(a.y),1/f)},axis:function(a){var b=this.super.axis.call(this,a);min=b[0];max=b[1];alpha=this._uniforms.polarAlpha;aspect=this._uniforms.polarAspect;
focus=this._uniforms.polarFocus;1==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspect,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,d=b.scale,f=b.polar,g=b.fold,b=b.power,h=1,e=c[0][0],i=c[1][0],j=c[2][0],k=c[0][1]-e,l=c[1][1]-i,c=c[2][1]-j,m=d[0],n=d[1],d=d[2],q=k+(l-k)*f,h=q/m/(l/n),r=[q/(2*m),0,0,e+k/2,0,l/(2*n),0,i+l/2,0,0,c/(2*d),j+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*m/q,0,0,-(2*e+k)*m/k,0,2*n/l,0,-(2*i+l)*n/l,0,0,2*d/
c,-(2*j+c)*d/c,0,0,0,1]);this.inverse.set.apply(this.inverse,r);this._uniforms.polarAlpha=f;this._uniforms.polarAspect=h;this._uniforms.polarFold=g;this._uniforms.polarPower=b;this._uniforms.polarFocus=0<f?1/f-1:0;MathBox.Viewport.prototype.update.call(this,a)},shader:function(a){a.snippet("polarPower").snippet("cartesianToPolar").snippet("mathToWorld")},validatePolar:function(a){return Math.max(0,Math.min(1,+a||0))}});MathBox.Attributes.mixin(MathBox.Viewport);MathBox.Viewport.types.polar=MathBox.ViewportPolar;
...
MathBox.ViewportSphere.prototype=_.extend(new MathBox.ViewportCartesian(null),{defaults:function(){return{type:"sphere",range:[[-1,1],[-1,1],[-1,1]],sphere:1,aspect:1,scale:[1,1,1],rotation:[0,0,0],position:[0,0,0]}},to:function(a){var b=this._uniforms.sphereAspectX,c=this._uniforms.sphereAspectY,d=this._uniforms.sphereYScale,f=this._uniforms.sphereFocus,g=this._uniforms.sphereAlpha;if(1E-4<g){var h=f+a.z*b,e=a.x*g,d=a.y*g/c*d,g=Math.cos(d)*h;a.x=Math.sin(e)*g;a.y=Math.sin(d)*h*c;a.z=(Math.cos(e)*
g-f)/b}this.transform.multiplyVector3(a)},from:function(a){var b=this._uniforms.sphereAspectX,c=this._uniforms.sphereAspectY,d=this._uniforms.sphereYScale,f=this._uniforms.sphereFocus,g=this._uniforms.sphereAlpha;this.inverse.multiplyVector3(a);if(1E-4<g){var h=a.x,e=a.y/c,i=a.z*b+f,j=Math.sqrt(h*h+e*e+i*i);theta=Math.atan2(e,Math.sqrt(h*h+e*e));phi=Math.atan2(h,i);a.x=theta/g;a.y=phi/g*c/d;a.z=(j-f)/b}},axis:function(a){var b=this.super.axis.call(this,a);min=b[0];max=b[1];alpha=this._uniforms.sphereAlpha;
beta=this._uniforms.sphereBeta;aspectX=this._uniforms.sphereAspectX;aspectY=this._uniforms.sphereAspectY;focus=this._uniforms.sphereFocus;2==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspectX,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,d=b.scale,b=b.sphere,f=0<b?1/b-1:0,g=c[0][0],h=c[1][0],e=c[2][0],i=c[0][1]-g,j=c[1][1]-h,c=c[2][1]-e,k=d[0],l=d[1],d=d[2],m=i+(c-i)*b,n=j+(c-j)*b,q=c/d;aspectX=m/k/q;aspectY=n/l/q/aspectX;aspectZ=2*(j/i*k/l);
yScale=Math.min(aspectY/b,1+(aspectZ-1)*b);q=[m/(2*k),0,0,g+i/2,0,n/(2*l),0,h+j/2,0,0,c/(2*d),e+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*k/m,0,0,-(2*g+i)*k/i,0,2*l/n,0,-(2*h+j)*l/j,0,0,2*d/c,-(2*e+c)*d/c,0,0,0,1]);this.inverse.set.apply(this.inverse,q);this._uniforms.sphereAlpha=b;this._uniforms.sphereAspectX=aspectX;this._uniforms.sphereAspectY=aspectY;this._uniforms.sphereYScale=yScale;this._uniforms.sphereFocus=f;MathBox.Viewport.prototype.update.call(this,a)},shader:function(a){a.snippet("cartesianToSphere").snippet("mathToWorld")},
