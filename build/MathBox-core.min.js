...
e.y),f.z=b(a.z,e.z),f):e.constructor==THREE.Color?(f=new THREE.Color,f.r=b(a.r,e.r),f.g=b(a.g,e.g),f.b=b(a.b,e.b),f):0.5<k?e:a}}this.start||this.init(a);var d=this.object;a=this.from;var e=this.to,g=this.key,h=this.ease,k;this.fraction=k=0<this.duration?Math.min(1,(MathBox.Animator.now-this.start)/(this.duration||1)):1;var f;switch(h){case "in":f=1-(1-k)*(1-k);break;case "out":f=k*k;break;case "linear":f=k;break;default:f=0.5-0.5*Math.cos(k*\u03c0)}a=c(a,e);this.object.set(this.key,a,!0)},hurry:function(a){this.duration=
...
MathBox.Ticks=function(a,b,c,d,e,g,h){var k=(b-a)/(c||10);d=d||1;e=e||10;var f=d*((h||0)+Math.pow(e,Math.floor(Math.log(k/d)/Math.log(e))));c=_.map(0==e%2?[e/2,1,0.5]:[1],function(a){return f*a});var l=_.reduce(c,function(a,b){return Math.abs(b-k)<Math.abs(a-k)?b:a},f);g=+!g;a=(Math.ceil(a/l)+g)*l;b=(Math.floor(b/l)-g)*l;c=Math.ceil((b-a)/l)+1;var m=[];_.loop(c,function(b){m.push(a+b*l)});return m};MathBox.TicksLog=function(a,b,c,d,e,g){};
...
[],b)if("style"==d)for(j in b.style)c.push(j);else c.push(d);return c}var c=[],d,e={};a.forEach(function(a){var c=a[0],d=a[1]||"",g=a[2]||{},h=a[3]||{};if("set"==c)return null;"add"==c&&(d=g.sequence);"remove"==c&&(h=g);b(a).forEach(function(a){a=[d,a].join(".");e[a]||(e[a]=[]);h=h||{};e[a].push((h.delay||0)+(h.duration||0)+(h.hold||0))})});var g=0;for(d in e)var h=e[d]=e[d].reduce(function(a,b){return a+b}),g=Math.max(g,h);a.forEach(function(a){var d=a[0],h=a[1]||"",m=a[2]||{},n=a[3]||{},t;if("set"==
d)return c.push(a);"add"==d&&(t=h,h=m.sequence);"remove"==d&&(n=m);b(a).forEach(function(a){var b=[h,a].join("."),k=n.delay||0,u=n.duration||0,v=n.hold||0;void 0!==e[b]&&(k+=g-e[b],delete e[b]);n={delay:k,duration:u,hold:v};"add"==d&&c.push([d,t,m,n]);"remove"==d?c.push([d,h,n]):(b={},b[a]=m.style&&void 0!==m.style[a]?m.style[a]:m[a],c.push([d,h,b,n]))})});return c},apply:function(a,b,c,d){var e=this._stage;_.each(a,function(a){var h=a[0]||"",k=a[1]||"",f=a[2]||{},l=a[3]||{};"remove"==h&&(l=f);b&&
...
n=c.tickScale,c=c.decimals,t=this.points,s=this.labelPoints,r=this.labelTangent,q=this.tickPoints,u=this.tickSigns,v=[0,0,0],x=new THREE.Vector3;new THREE.Vector4;var w=a.axis(d),y=w[0],w=w[1],A=(w-y)/(f-1);x.set.apply(x,e);_.loop(f,function(a){v[d]=y+a*A;t[a].set.apply(t[a],v);t[a].addSelf(x)});this.line.show(h);this.arrow.show(g);f=this.scale=MathBox.Ticks(y,w,l,m,n,!0);this.ticks.show(!!l);if(l){l=Math.floor(q.length/2);f.length>l&&(f=f.slice(0,l));var l=[0,0,0],z;l[2==d?0:1-d]=0.01*(w-y);this.epsilon.set.apply(this.epsilon,
l);v=[0,0,0];_.each(f,function(a,b){v[d]=a;var c=2*b;q[c].set.apply(q[c],v);q[c].addSelf(x);u[c]=1;q[c+1].copy(q[c]);u[c+1]=-1;s[b].copy(q[c]);z=c+1});l=z+1;for(f=q.length;l<f;)q[l].copy(q[z]),u[l]=u[z],l++}v=[0,0,0];v[d]=1;r.set.apply(r,v);this.labels.show(!!k);this.labels.set("decimals",c)},make:function(){var a=this.get(),b=a.n,c=a.size,d=a.ticks,e=a.distance,g=a.formatter,h=this.style,k=this.points=[],f=this.labelPoints=[],l=this.labelTangent=new THREE.Vector3,m=this.tickPoints=[],n=this.tickSigns=
[],t=this.epsilon=new THREE.Vector3;_.loop(b,function(a){k.push(new THREE.Vector3)});_.loop(4*d,function(a){f.push(new THREE.Vector3)});_.loop(8*d,function(a){m.push(new THREE.Vector3);n.push(1)});var d={dynamic:!0,size:c,offset:0.5},c={dynamic:!0,size:0.2*c},e={dynamic:!0,distance:e},s=function(b){b=this.scale[b];return 0!=b||a.zero?g?g(b):b:""}.bind(this);this.line=new MathBox.Renderable.Mesh(k,{dynamic:!0,type:"line"},h);this.arrow=new MathBox.Renderable.ArrowHead(k[b-2],k[b-1],d,h);this.ticks=
new MathBox.Renderable.Ticks(m,n,t,c,h);this.labels=new MathBox.Renderable.Labels(f,l,s,e,h)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
MathBox.Vector.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{n:1,data:null,arrow:!0,expression:function(){return 0},live:!0,style:{},size:0.07}},type:function(){return"vector"},renderables:function(){return this.render},adjust:function(a){var b=this.get();0<this.style.get("opacity")&&(b.arrow||b.live)&&this.calculate(a);_.each(this.arrows,function(a){a.show(b.arrow)})},make:function(){var a=this.get(),b=a.arrow,c=this.style,d=a.n,e=this.vertices=[],g=this.points=[],h=
this.render=[],k=this.arrows=[],f={dynamic:a.live,type:"line",strip:!1},l={size:a.size},m=0;_.loop(d,function(){e.push(new THREE.Vector3);e.push(new THREE.Vector3);g.push(new THREE.Vector3);g.push(new THREE.Vector3);if(b){var a=new MathBox.Renderable.ArrowHead(g[m++],g[m++],l,c);h.push(a);k.push(a)}});this.line=new MathBox.Renderable.Mesh(e,f,c);h.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.arrows,d=this.points,e=this.get(),g=e.data,h=e.arrow,k=e.n,f=e.size,
l=this.style.get("mathScale"),m=0,n=0;_.loop(2*k,function(k){p=g&&void 0!==g[k]?g[k]:e.expression.call(this,n,m);var s=0,r=0,q=0;if(p instanceof Array){var u=p.length;0<u&&(s=p[0]);1<u&&(r=p[1]);2<u&&(q=p[2])}else s=k,r=+p,q=0;d[k].set(s,r,q);b[k].set(s,r,q);a&&h&&1==k%2&&(s=MathBox.Vector.vLast,r=MathBox.Vector.vCurrent,r.copy(b[k]),s.copy(b[k-1]),a.to(r),a.to(s),r.subSelf(s).multiplySelf(l),u=r.length(),q=Math.min(1,0.5*u/f),q=(1-(1-q)*(1-q))*f,u-=q,r.normalize().multiplyScalar(u).divideSelf(l).addSelf(s),
a.from(r),b[k].copy(r),c[n].set({size:q}));n=m?n+1:n;m=(m+1)%2}.bind(this))}});MathBox.Primitive.types.vector=MathBox.Vector;MathBox.Surface=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
{type:"points",dynamic:a.live},b);if(a.shaded){var e=this.tangents=[[],[]];_.loop(c[0]*c[1],function(){e[0].push(new THREE.Vector3);e[1].push(new THREE.Vector3)})}this.calculate()},calculate:function(){var a=this.vertices,b=this.tangents,c=this.get(),d=c.data,e=c.domain,g=c.n,h=c.flipSided,k=h?1:0,h=h?0:1;"number"==typeof g&&(g=[g,g]);var f=e[0][0],l=e[1][0],m=(e[0][1]-f)/(g[0]-1),n=(e[1][1]-l)/(g[1]-1),t,s=0;_.loop(g[1],function(b){f=e[0][0];_.loop(g[0],function(e){t=d&&void 0!==d[b]&&void 0!==d[b][e]?
d[b][e]:c.expression.call(this,f,l,e,b,s);var g=e=0,h=0;if(t instanceof Array){var k=t.length;0<k&&(e=t[0]);1<k&&(g=t[1]);2<k&&(h=t[2])}else e=f,g=+t,h=l;a[s].set(e,g,h);f+=m;s++}.bind(this));l+=n}.bind(this));if(c.shaded){var s=0,l=e[1][0],r=g[0];_.loop(g[1],function(c){f=e[0][0];var d=c?c-1:0,h=Math.min(g[1]-1,c+1);_.loop(g[0],function(e){var k=e?e-1:0,l=Math.min(g[0]-1,e+1),n=a[e+c*r];l==e?b[0][s].sub(n,a[k+c*r]).addSelf(n):b[0][s].copy(a[l+c*r]);h==c?b[1][s].sub(n,a[e+d*r]).addSelf(n):b[1][s].copy(a[e+
...
m)/(h[0]-1),s=(c[1][1]-n)/(h[1]-1),r=0;_.loop(h[1],function(b){m=c[0][0];_.loop(h[0],function(b){a[r].set(m,n,0);m+=t;r++}.bind(this));n+=s}.bind(this));l={uniforms:l,shaders:{position:function(a,b){g?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(l);this.line.set(l);
...
adjust:function(a){var b=this.get(),c=b.offset,d=this._from.copy(this.from),e=this._to.copy(this.to);this.mathTransform.multiplyVector3(d);this.mathTransform.multiplyVector3(e);a.to(d);a.to(e);d=this.diff.sub(d,e);if(0.001>d.length())this.object.visible=!1;else{this.object.visible=this.visible;d=d.normalize();this.normal.x=this.diff.y+0.1;this.normal.y=this.diff.z+0.2;this.normal.z=this.diff.x+0.3;this.normal.normalize();var g=this.bi.cross(this.normal,this.diff).normalize(),h=this.normal.cross(this.bi,
...
if(+d==d){var q=+d;if(0!=q)var d=0>q?-1:1,q=Math.abs(q),u=Math.pow(10,f-1-Math.floor(Math.log(q)*n)),d=q=d*Math.round(u*q)/u}m||(d=(""+d).replace(/^-/,"\u2013"))}b.content!==d&&(q=b.element.children[0],b.content=d,b.measure=!0,m?(q.innerHTML="\\("+d+"\\)",MathJax.Hub.queue.Push(["Typeset",MathJax.Hub,q])):q.innerHTML=d)});MathBox.Renderable.prototype.adjust.call(this,a)}});
...
a);min=b[0];max=b[1];alpha=this._uniforms.polarAlpha;aspect=this._uniforms.polarAspect;focus=this._uniforms.polarFocus;1==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspect+0.001,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,d=b.scale,e=b.polar,g=b.fold,h=b.power,b=b.helix,k=1,f=c[0][0],l=c[1][0],m=c[2][0],n=c[0][1]-f,t=c[1][1]-l,c=c[2][1]-m,s=d[0],r=d[1],d=d[2],k=0<n?1:-1,q=Math.abs(t),q=n+(q*k-n)*e,k=Math.abs(q/s/(t/r)),u=[q/(2*s),0,0,f+n/2,
0,t/(2*r),0,l+t/2,0,0,c/(2*d),m+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*s/q,0,0,-(2*f+n)*s/n,0,2*r/t,0,-(2*l+t)*r/t,0,0,2*d/c,-(2*m+c)*d/c,0,0,0,1]);this.inverse.set.apply(this.inverse,u);this._uniforms.polarAlpha=e;this._uniforms.polarAspect=k;this._uniforms.polarFold=g;this._uniforms.polarPower=h;this._uniforms.polarFocus=0<e?1/e-1:0;this._uniforms.polarHelix=b;MathBox.Viewport.prototype.update.call(this,a)},shader:function(a){a.snippet("polarPower").snippet("cartesianToPolar").snippet("mathToWorld")},
