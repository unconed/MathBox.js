...
function(a){c.push(["add",a.type(),b.get(a)])});break;case "animate":case "set":d=b.select(f),_.each(d,function(a){var d=Math.min(300,h&&void 0!==h.duration?h.duration:300);c.push([e,a.singleton||a.get("sequence"),b.get(a),{duration:d}])})}return c},apply:function(a,b,c){var d=this._stage;_.each(a,function(a){var f=a[0]||"",j=a[1]||"",h=a[2]||{},g=a[3]||{};"remove"==f&&(g=h);b&&(a=this.invert(a),a=[0,0].concat(a),Array.prototype.splice.apply(b,a));c&&g&&(g=_.extend({},g),g.delay=0,g.duration/=2);
switch(f){case "clone":d.clone(j,h,g);break;case "add":d.spawn(j,h,g);break;case "remove":_.each(d.select(j),function(a){d.remove(a,g)});break;case "set":var f=d.select(j),k=h.constructor==Array;_.each(f,function(a,b){d.set(a,k?h[b]:h)});break;case "animate":f=d.select(j),k=h.constructor==Array,_.each(f,function(a,b){d.animate(a,k?h[b]:h,g)})}}.bind(this));return this},insert:function(a){a[0].constructor!=Array&&(a=[a]);this.script.splice(this.step,0,a);this.forward();return this},is:function(a){if(!this.script.length)return!1;
...
g[1][2],g[2][2],g[3][2],g[4][2],g[5][2],g[6][2],g[7][2],g[8][2],g[9][2],g[10][2],g[11][2],g[12][2],g[13][2],g[14][2],g[15][2]);var k=this.coefficients;this.matrixX.multiplySelf(k).transpose().multiplySelf(k);this.matrixY.multiplySelf(k).transpose().multiplySelf(k);this.matrixZ.multiplySelf(k).transpose().multiplySelf(k);var k={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},m=c[0][0],l=c[1][0],q=(c[0][1]-m)/(j[0]-1),n=(c[1][1]-l)/(j[1]-1),r=0;_.loop(j[1],function(){m=
c[0][0];_.loop(j[0],function(){a[r].set(m,l,0);m+=q;r++}.bind(this));l+=n}.bind(this));k={uniforms:k,shaders:{position:function(a,b){f?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(k);this.line.set(k);this.points.set(k)}});MathBox.Primitive.types.bezierSurface=MathBox.BezierSurface;
