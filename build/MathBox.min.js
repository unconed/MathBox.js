...
"10px",a&&a.appendChild(c.stats.domElement),c.loopStats=function(){c.stats.update()},this.loop().hook(c.loopStats));if(b.cameraControls){var f=this.loop(),k=this.render.bind(this);c.cameraControls=new b.controlClass(d,a,b);if(c.cameraControls.on)c.cameraControls.on("change",function(){f._timerId||k()});this.setCameraControls(c.cameraControls)}b.elementResize&&(c.elementResize=ThreeBox.ElementResize.bind(e,d,a,b).on("resize",function(a,b){this._opts.renderW=a;this._opts.renderH=b;this.emit("resize",
...
ThreeBox.Cursor=function(a,b){function c(){f||(a.style.cursor=d);clearTimeout(e);f=!1;e=setTimeout(function(){f=!0;a.style.cursor="none"},k)}var d=b.cameraControls?"move":"default",e=null,f=!1,k=2E3;b.cursor?a.style.cursor=d:(a.addEventListener("mousemove",c),a.style.cursor="none");return{unbind:function(){a.removeEventListener("mousemove",c)}}};ThreeBox.Cursor.bind=function(a,b){return ThreeBox.Cursor(a,b)};
ThreeBox.preload=function(a,b){a instanceof Function&&(b=a,a=[]);a="string"==typeof a?[a]:a;var c=a.length,d={},e=function(a){_.extend(d,a||{});0==--c&&b(d)},f=ThreeBox.preload,k={},h={html:f.html,jpg:f.image,png:f.image,gif:f.image,mp3:f.audio};_.each(h,function(a,b){k[b]=RegExp("\\."+b+"$")});_.each(a,function(a){_.each(h,function(b,c){if(a.match(k[c])){var d=a.split(/\//g).pop().replace(/\.[A-Za-z0-9]+$/,"");b(a,d,e)}})})};
...
b=b.slice(0,n);_.each(b,function(a,b){a.width=this.width;a.height=this.height;a.__index=b}.bind(this));this.virtuals=b;this.index=-1;this.advance()},advance:function(){var a=this.targets,b=this.virtuals,c=this.index,d=this.buffers,e=b.length;this.index=c=(c+1)%d;_.loop(e,function(f){var k=b[f];f=a[(e-f+c)%d];k.__webglTexture=f.__webglTexture;k.__webglFramebuffer=f.__webglFramebuffer;k.__webglRenderbuffer=f.__webglRenderbuffer;k.__index=f.__index})},clear:function(){var a=this.options,b=a.clear,c=
...
ThreeRTT.DownsampleMaterial=function(a,b){var c={};a=ThreeRTT.toTarget(a);b=ThreeRTT.toTarget(b);c=_.extend(c,{sampleAlignment:{type:"v2",value:new THREE.Vector2},texture:{type:"t",value:a.read()}});b.on("render",function(){var d=a,f=b,k=2*f.height/d.height,h=c.sampleAlignment.value;h.x=2*f.width/d.width;h.y=k});var d=new THREE.ShaderMaterial({uniforms:c,vertexShader:ThreeRTT.getShader("rtt-vertex-downsample"),fragmentShader:ThreeRTT.getShader("generic-fragment-texture")});d.side=THREE.DoubleSide;
...
ThreeRTT.Display.prototype=_.extend(new THREE.Object3D,{make:function(){for(var a=this.n,b=this.gx,c=this.gy,d=this.targets,e=(b-1)/2,f=(c-1)/2,k=new THREE.PlaneGeometry(1,1,1,1),h=0,g=0;h<a&&g<c;++g)for(var l=0;h<a&&l<b;++l,++h){var m=new THREE.MeshBasicMaterial({color:16777215,map:ThreeRTT.toTexture(d[h]),fog:!1});m.side=THREE.DoubleSide;m=new THREE.Mesh(k,m);m.renderDepth=1E4+Math.random();this.add(m);1<b&&(m.position.x=-e+l);1<c&&(m.position.y=f-g)}}});
...
MathBox.Attributes.prototype={get:function(a){return void 0===a?this.__attributes||{}:this.__attributes?this.__attributes[a]:void 0},set:function(a,b){function c(a,b){try{b=h(a,b),d[a]=b,f[a]=b}catch(c){throw"Exception setting '"+a+"' to '"+b+"': "+c;}}this.__attributes||(this.__attributes={});this.__validators||(this.__validators={});var d={},e=this.__validators,f=this.__attributes,k=this,h=function(a,b){if(void 0===e[a]){var c="validate"+a.charAt(0).toUpperCase()+a.slice(1);e[a]=k[c]||!1}return e[a]?
...
function(b,e){_.each(a.__queue[e],function(a){a.hurry(c)})}.bind(this))},stop:function(a,b){_.each(b||a.__queue,function(b,d){for(;a.__queue[d];)this.dequeue(a,d,!0)}.bind(this))},animate:function(a,b,c){c=_.extend({duration:300},c||{});this.attach(a);_.each(b,function(b,e){var f=a.__queue[e]=a.__queue[e]||[];if(c.delay){var k=new MathBox.Animator.Delay(a,e,c.delay);f.push(k);0==a.__animations++&&this.active.push(a)}a.__validators[e]&&(b=a.__validators[e].call(a,b));k=new MathBox.Animator.Animation(a,
e,b,c.duration,c.callback,c.ease);f.push(k);0==a.__animations++&&this.active.push(a)}.bind(this))},dequeue:function(a,b,c){var d=a.__queue[b];if(d){var e=d.shift();0==d.length&&delete a.__queue[b];c&&e.skip();0==--a.__animations&&this.active.splice(this.active.indexOf(a),1)}},update:function(a){MathBox.Animator.now+=a;a=this.active.slice();_.each(a,function(a){var c=0;_.each(a.__queue,function e(f,k){var h=f[0];value=h.apply(c||0);h.done()&&(c=h.extra(),this.dequeue(a,k),f[0]&&e.call(this,f,k))}.bind(this))}.bind(this))}};
...
typeof d+")";case "function":return function(){return b(a.apply(this,arguments),d.apply(this,arguments))};case "boolean":return 0.5<k?d:a;case "number":return a+(d-a)*h;case "object":if(!a)return d;if(!d)return a;if(d.constructor==Array)return f=[],_.loop(a.length,function(c){f[c]=b(a[c],d[c])}),f;if(d.constructor==THREE.Matrix4){f=new THREE.Matrix4;for(var q=0;16>q;++q)f.elements[q]=a.elements[q]+(d.elements[q]-a.elements[q])*h;return f}return d.constructor==THREE.Vector3?(f=new THREE.Vector3,f.x=
a.x+(d.x-a.x)*h,f.y=a.y+(d.y-a.y)*h,f.z=a.z+(d.z-a.z)*h,f):d.constructor==THREE.Color?(f=new THREE.Color,f.r=a.r+(d.r-a.r)*h,f.g=a.g+(d.g-a.g)*h,f.b=a.b+(d.b-a.b)*h,f):0.5<k?d:a}}this.start||this.init(a);var c=this.object;a=this.from;var d=this.to,e=this.key,f=this.ease,k;this.fraction=k=0<this.duration?Math.min(1,(MathBox.Animator.now-this.start)/(this.duration||1)):1;var h;switch(f){case "in":h=1-(1-k)*(1-k);break;case "out":h=k*k;break;case "linear":h=k;break;default:h=0.5-0.5*Math.cos(k*\u03c0)}a=
...
b,c){var d=this.animator;b=this.extractStyle(b);c=this.animateOptions(c,!0);b.style&&(_.each(this.select(a),function(a){d.animate(a.style,b.style,c)}),b=_.extend({},b),delete b.style);_.each(this.select(a),function(a){d.animate(a,b,c)});return this},clone:function(a,b,c){_.each(this.select(a),function(a){var e=this.get(a);delete e.sequence;var f=_.extend({},b),k=[];_.each(b,function(a,c){if("id"==c||"boolean"==typeof a||null===a)e[c]=b[c],k.push(c)});_.each(k,function(a){delete f[a]});e.id==a.get("id")&&
...
MathBox.Ticks=function(a,b,c,d,e,f,k){var h=(b-a)/(c||10);d=d||1;e=e||10;var g=d*((k||0)+Math.pow(e,Math.floor(Math.log(h/d)/Math.log(e))));c=_.map(0==e%2?[e/2,1,0.5]:[1],function(a){return g*a});var l=_.reduce(c,function(a,b){return Math.abs(b-h)<Math.abs(a-h)?b:a},g);f=+!f;a=(Math.ceil(a/l)+f)*l;b=(Math.floor(b/l)-f)*l;c=Math.ceil((b-a)/l)+1;var m=[];_.loop(c,function(b){m.push(a+b*l)});return m};MathBox.TicksLog=function(a,b,c,d,e,f){};
...
MathBox.Director.prototype={clock:function(a,b){if(a>this.step)return 0;var c=+new Date;this.time+=(c-this.lastTime)*this.stage().speed();this.lastTime=c;if(b||!this.clocks[a])this.clocks[a]=this.time;return 0.001*(this.time-this.clocks[a])},invert:function(a){var b=this._stage,c=[],d,e=a[0],f=a[1],k=a[2],h=a[3];switch(e){case "add":d=[0];case "clone":d=d||b.select(f);_.each(d,function(a,b){c.push(["remove",k.sequence||MathBox.Primitive.sequence+1+b])});break;case "remove":d=b.select(f);_.each(d,
function(a){c.push(["add",a.type(),b.get(a)])});break;case "animate":case "set":d=b.select(f),_.each(d,function(a){var d=Math.min(300,h&&void 0!==h.duration?h.duration:0);c.push([e,a.singleton||a.get("sequence"),b.get(a),{duration:d}])})}return c},apply:function(a,b,c,d){var e=this._stage;_.each(a,function(a){var k=a[0]||"",h=a[1]||"",g=a[2]||{},l=a[3]||{};"remove"==k&&(l=g);b&&(a=this.invert(a),a=[0,0].concat(a),Array.prototype.splice.apply(b,a));d&&l&&(l=_.extend({},l),l.delay=0,l.duration/=2);
c&&(l={delay:0,duration:0},"animate"==k&&(k="set"));switch(k){case "clone":e.clone(h,g,l);break;case "add":e.spawn(h,g,l);break;case "remove":_.each(e.select(h),function(a){e.remove(a,l)});break;case "set":var k=e.select(h),m=g.constructor==Array;_.each(k,function(a,b){e.set(a,m?g[b]:g)});break;case "animate":k=e.select(h),m=g.constructor==Array,_.each(k,function(a,b){e.animate(a,m?g[b]:g,l)})}}.bind(this));return this},insert:function(a){a[0].constructor!=Array&&(a=[a]);this.script.splice(this.step,
...
function(b){if(b===a)found=!0;else if(found&&b.render){var h=b.left,g=b.top,l=b.width+h,m=b.height+g;e<h||c>l||(f<g||d>m)||(b.element.style.display="none",b.render=!1)}})}},_update:function(a,b){for(var c=this.v,d=this.q,e=a.render,f=a.visible,k=a.parent;f&&k;)f=f&&k.visible,k=k.parent;a.render=f&&0<a.opacity;if(a.render)e||(a.element.style.display="block"),c.copy(a.position),b.matrixWorldInverse.multiplyVector3(c),e=-(c.x/c.z)*this.fov+0.5*this.width,f=c.y/c.z*this.fov+0.5*this.height,a.distance&&
(d.copy(a.tangent).multiplyScalar(0.01),d.addSelf(a.position),b.matrixWorldInverse.multiplyVector3(d),k=0<a.distance?1:-1,d.subSelf(c),d.z=0,d.normalize().multiplyScalar(a.distance),e+=Math.abs(d.y)*k,f+=Math.abs(d.x)*k),e=Math.round(e),f=Math.round(f),a.left!==e&&(a.left=e,a.element.style.left=e+"px"),a.top!==f&&(a.top=f,a.element.style.top=f+"px"),a.lastOpacity!==a.opacity&&(a.element.style.opacity=a.opacity,a.lastOpacity=a.opacity);else if(e||null===e)a.element.style.display="none"}};
...
function(){d.push(new THREE.Vector3)});c=function(c){return new MathBox.Renderable.Mesh(d,{type:c,dynamic:a.live},b)};this.line=c("line");this.points=c("points");this.calculate()},calculate:function(){var a=this.vertices,b=this.get(),c=b.data,d=b.domain,e=b.n,f=d[0],k=(d[1]-f)/(e-1),h;_.loop(e,function(d){h=c&&void 0!==c[d]?c[d]:b.expression.call(this,f,d);h instanceof Array||(h=[f,h,0]);h=h.concat([0,0,0]);a[d].set.apply(a[d],h);f+=k}.bind(this))}});MathBox.Primitive.types.curve=MathBox.Curve;
MathBox.Bezier=function(a){MathBox.Curve.call(this,a)};
MathBox.Bezier.prototype=_.extend(new MathBox.Curve(null),{defaults:function(){return{n:64,domain:[0,1],data:null,order:3,expression:function(){return 0},live:!0,points:!1,line:!0,style:{}}},type:function(){return"bezier"},calculate:function(){var a=this.vertices,b=this.get(),c=b.domain,d=b.data,e=b.order,f=b.n;if(1>e||3<e)throw"Bezier curve order must be 1, 2 or 3.";var k=[],h;_.loop(e+1,function(a){h=d&&void 0!==d[a]?d[a]:b.expression.call(this,a,a);h instanceof Array||(h=[l,h,0]);h=h.concat([0,
0,0]);k.push(new THREE.Vector3(h[0],h[1],h[2]))}.bind(this));var g={bezierPoints:k},l=c[0],m=(c[1]-l)/(f-1);_.loop(f,function(b){a[b].set(l,0,0);l+=m});c={uniforms:g,shaders:{position:function(a,b){a.snippet("bezier"+e).snippet("mathTransform");b.viewport(a)}}};this.line.set(c);this.points.set(c)}});MathBox.Primitive.types.bezier=MathBox.Bezier;MathBox.Axis=function(a){null!==a&&MathBox.Primitive.call(this,a)};
MathBox.Axis.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{axis:0,offset:[0,0,0],n:2,arrow:!0,line:!0,labels:!1,decimals:2,distance:15,ticks:10,tickUnit:1,tickScale:10,size:0.07,style:{lineWidth:4,color:new THREE.Color(7368816)},formatter:null,zero:!0}},renderables:function(){return[this.line,this.ticks,this.arrow,this.labels]},type:function(){return"axis"},adjust:function(a,b){var c=this.get(),d=c.axis,e=c.offset,f=c.arrow,k=c.line,h=c.labels,g=c.n,l=c.ticks,m=c.tickUnit,
q=c.tickScale,c=c.decimals,r=this.points,s=this.labelPoints,u=this.labelTangent,t=this.tickPoints,v=this.tickSigns,w=[0,0,0],y=new THREE.Vector3;new THREE.Vector4;var x=a.axis(d),z=x[0],x=x[1],B=(x-z)/(g-1);y.set.apply(y,e);_.loop(g,function(a){w[d]=z+a*B;r[a].set.apply(r[a],w);r[a].addSelf(y)});this.line.show(k);this.arrow.show(f);g=this.scale=MathBox.Ticks(z,x,l,m,q,!0);this.ticks.show(!!l);if(l){l=Math.floor(t.length/2);g.length>l&&(g=g.slice(0,l));var l=[0,0,0],A;l[2==d?0:1-d]=0.01*(x-z);this.epsilon.set.apply(this.epsilon,
l);w=[0,0,0];_.each(g,function(a,b){w[d]=a;var c=2*b;t[c].set.apply(t[c],w);t[c].addSelf(y);v[c]=1;t[c+1].copy(t[c]);v[c+1]=-1;s[b].copy(t[c]);A=c+1});l=A+1;for(g=t.length;l<g;)t[l].copy(t[A]),v[l]=v[A],l++}w=[0,0,0];w[d]=1;u.set.apply(u,w);this.labels.show(!!h);this.labels.set("decimals",c)},make:function(){var a=this.get(),b=a.n,c=a.size,d=a.ticks,e=a.distance,f=a.formatter,k=this.style,h=this.points=[],g=this.labelPoints=[],l=this.labelTangent=new THREE.Vector3,m=this.tickPoints=[],q=this.tickSigns=
[],r=this.epsilon=new THREE.Vector3;_.loop(b,function(a){h.push(new THREE.Vector3)});_.loop(4*d,function(a){g.push(new THREE.Vector3)});_.loop(8*d,function(a){m.push(new THREE.Vector3);q.push(1)});var d={dynamic:!0,size:c,offset:0.5},c={dynamic:!0,size:0.2*c},e={dynamic:!0,distance:e},s=function(b){b=this.scale[b];return 0!=b||a.zero?f?f(b):b:""}.bind(this);this.line=new MathBox.Renderable.Mesh(h,{dynamic:!0,type:"line"},k);this.arrow=new MathBox.Renderable.ArrowHead(h[b-2],h[b-1],d,k);this.ticks=
new MathBox.Renderable.Ticks(m,q,r,c,k);this.labels=new MathBox.Renderable.Labels(g,l,s,e,k)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
MathBox.Grid.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{axis:[0,1],offset:[0,0,0],show:[!0,!0],n:2,ticks:[10,10],tickUnit:[1,1],tickScale:[10,10],style:{lineWidth:1,color:new THREE.Color(10526880)}}},type:function(){return"grid"},renderables:function(){return this.lines||[]},adjust:function(a){function b(a,b,c,d,e){var f=l.slice(),k=0,g=MathBox.Ticks(b.min,b.max,b.ticks,b.tickUnit,b.tickScale,!0);g.length>d&&(g=g.slice(0,d));_.each(g,function(d){f[b.axis]=d+l[b.axis];
f[c.axis]=c.min+l[c.axis];_.loop(e-1,function(b){a[k].set.apply(a[k],f);k++;f[c.axis]+=c.inv;a[k].set.apply(a[k],f);k++})});d=Math.max(0,k-1);for(g=a.length;k<g;)a[k++].copy(a[d])}var c=this.get(),d=c.axis,e=c.ticks,f=c.tickUnit,k=c.tickScale,h=c.n,g=c.show,l=c.offset,c=this.points,m=this.limit,q=[];"number"==typeof h&&(h=[h,h]);_.each(d,function(b,c){var d=a.axis(b);q.push({axis:b,min:d[0],max:d[1],inv:(d[1]-d[0])/(h[c]-1),ticks:e[c],tickUnit:f[c],tickScale:k[c]})});this.lines[0].show(g[0]);this.lines[1].show(g[1]);
g[0]&&b(c[0],q[1],q[0],m[0],h[0]);g[1]&&b(c[1],q[0],q[1],m[1],h[1])},make:function(a){var b=this.get();a=b.ticks;var c=b.n,d=this.points=[[],[]],b=this.style;"number"==typeof c&&(c=[c,c]);var e=this.limit=[0,0];_.each(a,function(a,b){b=1-b;e[b]=4*a;_.loop(2*e[b]*(c[b]-1),function(a){d[b].push(new THREE.Vector3)})});this.lines=[];this.lines.push(new MathBox.Renderable.Mesh(d[0],{type:"line",strip:!1,dynamic:!0},b));this.lines.push(new MathBox.Renderable.Mesh(d[1],{type:"line",strip:!1,dynamic:!0},
...
MathBox.Vector.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{n:1,data:null,arrow:!0,expression:function(){return 0},live:!0,style:{},size:0.07}},type:function(){return"vector"},renderables:function(){return this.render},adjust:function(a){var b=this.get();(b.arrow||b.live)&&this.calculate(a);_.each(this.arrows,function(a){a.show(b.arrow)})},make:function(){var a=this.get(),b=a.arrow,c=this.style,d=a.n,e=this.vertices=[],f=this.points=[],k=this.render=[],h=this.arrows=
[],g={dynamic:a.live,type:"line",strip:!1},l={size:a.size},m=0;_.loop(d,function(){e.push(new THREE.Vector3);e.push(new THREE.Vector3);f.push(new THREE.Vector3);f.push(new THREE.Vector3);if(b){var a=new MathBox.Renderable.ArrowHead(f[m++],f[m++],l,c);k.push(a);h.push(a)}});this.line=new MathBox.Renderable.Mesh(e,g,c);k.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.arrows,d=this.points,e=this.get(),f=e.data,k=e.arrow,h=e.n,g=e.size,l=this.style.get("mathScale"),
m=new THREE.Vector3,q=new THREE.Vector3,r=0,s=0;_.loop(2*h,function(h){p=f&&void 0!==f[h]?f[h]:e.expression.call(this,s,r);p instanceof Array||(p=[h,p,0]);p=p.concat([0,0,0]);d[h].set.apply(d[h],p);b[h].set.apply(b[h],p);if(a&&k&&1==h%2){q.copy(b[h]);m.copy(b[h-1]);a.to(q);a.to(m);q.subSelf(m).multiplySelf(l);var t=q.length(),v=Math.min(1,0.5*t/g),v=(1-(1-v)*(1-v))*g,t=t-v;q.normalize().multiplyScalar(t).divideSelf(l).addSelf(m);a.from(q);b[h].copy(q);c[s].set({size:v})}s=r?s+1:s;r=(r+1)%2}.bind(this))}});
...
{type:"points",dynamic:a.live},b);if(a.shaded){var e=this.tangents=[[],[]];_.loop(c[0]*c[1],function(){e[0].push(new THREE.Vector3);e[1].push(new THREE.Vector3)})}this.calculate()},calculate:function(){var a=this.vertices,b=this.tangents,c=this.get(),d=c.data,e=c.domain,f=c.n,k=c.flipSided,h=k?1:0,k=k?0:1;"number"==typeof f&&(f=[f,f]);var g=e[0][0],l=e[1][0],m=(e[0][1]-g)/(f[0]-1),q=(e[1][1]-l)/(f[1]-1),r,s=0;_.loop(f[1],function(b){g=e[0][0];_.loop(f[0],function(e){r=d&&void 0!==d[b]&&void 0!==d[b][e]?
d[b][e]:c.expression.call(this,g,l,e,b,s);r instanceof Array||(r=[g,r,l]);r=r.concat([0,0,0]);a[s].set.apply(a[s],r);g+=m;s++}.bind(this));l+=q}.bind(this));if(c.shaded){var s=0,l=e[1][0],u=f[0];_.loop(f[1],function(c){g=e[0][0];var d=c?c-1:0,k=Math.min(f[1]-1,c+1);_.loop(f[0],function(e){var h=e?e-1:0,l=Math.min(f[0]-1,e+1),q=a[e+c*u];l==e?b[0][s].sub(q,a[h+c*u]).addSelf(q):b[0][s].copy(a[l+c*u]);k==c?b[1][s].sub(q,a[e+d*u]).addSelf(q):b[1][s].copy(a[e+k*u]);g+=m;s++});l+=q});this.line.set("attributes",
...
MathBox.BezierSurface.prototype=_.extend(new MathBox.Surface(null),{defaults:function(){return{n:[64,64],domain:[[0,1],[0,1]],data:null,order:3,expression:function(){return 0},live:!0,points:!1,line:!1,mesh:!0,doubleSided:!0,flipSided:!1,shaded:!0,style:{}}},type:function(){return"bezierSurface"},calculate:function(){var a=this.vertices,b=this.get(),c=b.domain,d=b.data,e=b.order,f=b.shaded,k=b.n;"number"==typeof k&&(k=[k,k]);if(3!=e)throw"Bezier surface order must be 3.";var h=[],g;_.loop(e+1,function(a){_.loop(e+
1,function(c){g=d&&void 0!==d[a]&&void 0!==d[a][c]?d[a][c]:b.expression.call(this,c,a,c,a);g instanceof Array||(g=[c,g,a]);g=g.concat([0,0,0]);h.push(g)}.bind(this))}.bind(this));g=h;this.matrixX.set(g[0][0],g[1][0],g[2][0],g[3][0],g[4][0],g[5][0],g[6][0],g[7][0],g[8][0],g[9][0],g[10][0],g[11][0],g[12][0],g[13][0],g[14][0],g[15][0]);this.matrixY.set(g[0][1],g[1][1],g[2][1],g[3][1],g[4][1],g[5][1],g[6][1],g[7][1],g[8][1],g[9][1],g[10][1],g[11][1],g[12][1],g[13][1],g[14][1],g[15][1]);this.matrixZ.set(g[0][2],
g[1][2],g[2][2],g[3][2],g[4][2],g[5][2],g[6][2],g[7][2],g[8][2],g[9][2],g[10][2],g[11][2],g[12][2],g[13][2],g[14][2],g[15][2]);var l=this.coefficients;this.matrixX.multiplySelf(l).transpose().multiplySelf(l);this.matrixY.multiplySelf(l).transpose().multiplySelf(l);this.matrixZ.multiplySelf(l).transpose().multiplySelf(l);var l={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},m=c[0][0],q=c[1][0],r=(c[0][1]-m)/(k[0]-1),s=(c[1][1]-q)/(k[1]-1),u=0;_.loop(k[1],function(b){m=
c[0][0];_.loop(k[0],function(b){a[u].set(m,q,0);m+=r;u++}.bind(this));q+=s}.bind(this));l={uniforms:l,shaders:{position:function(a,b){f?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(l);this.line.set(l);this.points.set(l)}});MathBox.Primitive.types.bezierSurface=MathBox.BezierSurface;
...
adjust:function(a){var b=this.get(),c=b.offset,d=this._from.copy(this.from),e=this._to.copy(this.to);this.mathTransform.multiplyVector3(d);this.mathTransform.multiplyVector3(e);a.to(d);a.to(e);d=this.diff.sub(d,e);if(0.001>d.length())this.object.visible=!1;else{this.object.visible=this.visible;d=d.normalize();this.normal.x=this.diff.y+0.1;this.normal.y=this.diff.z+0.2;this.normal.z=this.diff.x+0.3;this.normal.normalize();var f=this.bi.cross(this.normal,this.diff),k=this.normal.cross(this.bi,this.diff),
b=b.size,e=(new THREE.Matrix4(f.x,d.x,k.x,e.x,f.y,d.y,k.y,e.y,f.z,d.z,k.z,e.z,0,0,0,1)).scale(new THREE.Vector3(b,b,b));this.object.updateMatrix();this.object.matrix.multiplySelf(e);e.identity().setPosition({x:0,y:0.5-c,z:0});this.object.matrix.multiplySelf(e);this.object.matrixAutoUpdate=!1;this.object.matrixWorldNeedsUpdate=!0;MathBox.Renderable.prototype.adjust.call(this,a)}}});
...
d.className="mathbox-wrap";d.style.position="relative";d.style.display="inline-block";d.style.left="-50%";d.style.top="-.5em";c.push(h);e.add(h)})},adjust:function(a,b,c,d,e){var f=this.get(),k=this.points;b=this.sprites;var h=this.callback,g=f.decimals,l=this.style.get("opacity"),m=window.MathJax&&MathJax.Hub,q=1/Math.log(10);_.each(b,function(b,c){b.position.copy(k[c]);a.to(b.position);e.matrix.multiplyVector3(b.position);b.distance=f.distance;b.opacity=l;var d="";if(h){d=h(c);void 0===d&&(d="");
if(+d==d){var t=+d;if(0!=t)var d=0>t?-1:1,t=Math.abs(t),v=Math.pow(10,g-1-Math.floor(Math.log(t)*q)),d=t=d*Math.round(v*t)/v}m||(d=(""+d).replace(/^-/,"\u2013"))}b.content!==d&&(t=b.element.children[0],b.content=d,b.measure=!0,m?(t.innerHTML="\\("+d+"\\)",MathJax.Hub.queue.Push(["Typeset",MathJax.Hub,t])):t.innerHTML=d)});MathBox.Renderable.prototype.adjust.call(this,a)}});
...
MathBox.ViewportPolar.prototype=_.extend(new MathBox.ViewportCartesian(null),{defaults:function(){return{type:"polar",range:[[-1,1],[-1,1],[-1,1]],polar:1,fold:1,power:1,helix:0,scale:[1,1,1],rotation:[0,0,0],position:[0,0,0]}},to:function(a){var b=this._uniforms.polarAspect,c=this._uniforms.polarFocus,d=this._uniforms.polarAlpha,e=this._uniforms.polarPower,f=this._uniforms.polarHelix;a.x*=this._uniforms.polarFold;a.y=Math.sign(a.y)*Math.pow(Math.abs(a.y),e);if(1E-4<d){var e=c+a.y*b,k=a.x*d;a.z+=
a.x*f*d;a.x=Math.sin(k)*e;a.y=(Math.cos(k)*e-c)/b}this.transform.multiplyVector3(a)},from:function(a){var b=this._uniforms.polarAspect,c=this._uniforms.polarFocus,d=this._uniforms.polarAlpha,e=this._uniforms.polarFold,f=this._uniforms.polarPower,k=this._uniforms.polarHelix;this.inverse.multiplyVector3(a);if(1E-4<d){var h=a.x,g=a.y*b+c,l=Math.sqrt(h*h+g*g);theta=Math.atan2(h,g);a.x=theta/d;a.y=(l-c)/b;a.z-=a.x*k*d}a.x/=e;a.y=Math.sign(a.y)*Math.pow(Math.abs(a.y),1/f)},axis:function(a){var b=this.super.axis.call(this,
a);min=b[0];max=b[1];alpha=this._uniforms.polarAlpha;aspect=this._uniforms.polarAspect;focus=this._uniforms.polarFocus;1==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspect+0.001,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,d=b.scale,e=b.polar,f=b.fold,k=b.power,b=b.helix,h=1,g=c[0][0],l=c[1][0],m=c[2][0],q=c[0][1]-g,r=c[1][1]-l,c=c[2][1]-m,s=d[0],u=d[1],d=d[2],h=0<q?1:-1,t=Math.abs(r),t=q+(t*h-q)*e,h=Math.abs(t/s/(r/u)),v=[t/(2*s),0,0,g+q/2,
0,r/(2*u),0,l+r/2,0,0,c/(2*d),m+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*s/t,0,0,-(2*g+q)*s/q,0,2*u/r,0,-(2*l+r)*u/r,0,0,2*d/c,-(2*m+c)*d/c,0,0,0,1]);this.inverse.set.apply(this.inverse,v);this._uniforms.polarAlpha=e;this._uniforms.polarAspect=h;this._uniforms.polarFold=f;this._uniforms.polarPower=k;this._uniforms.polarFocus=0<e?1/e-1:0;this._uniforms.polarHelix=b;MathBox.Viewport.prototype.update.call(this,a)},shader:function(a){a.snippet("polarPower").snippet("cartesianToPolar").snippet("mathToWorld")},
