...
q)var d=0>q?-1:1,q=Math.abs(q),s=Math.pow(10,1-Math.floor(Math.log(q)/Math.log(10))),d=q=d*Math.round(s*q)/s}k||(d=(""+d).replace(/^-/,"\u2013"))}b.content!==d&&(q=b.element.children[0],b.content=d,b.measure=!0,k?(q.innerHTML="\\("+d+"\\)",MathJax.Hub.queue.Push(["Typeset",MathJax.Hub,q])):q.innerHTML=d)});MathBox.Renderable.prototype.adjust.call(this,a)}});MathBox.Viewport=function(a){if(null!==a){var b=this.defaults();a=_.extend(b,a||{});this.set(a);this.singleton="viewport";this._uniforms={}}};
