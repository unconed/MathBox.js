...
animate:function(a,b,c){var d=this.animator;b=this.extractStyle(b);c=this.animateOptions(c,!0);b.style&&(_.each(this.select(a),function(a){d.animate(a.style,b.style,c)}),b=_.extend({},b),delete b.style);_.each(this.select(a),function(a){d.animate(a,b,c)});return this},clone:function(a,b,c){_.each(this.select(a),function(a){var e=this.get(a);delete e.sequence;var f=_.extend({},b),j=[];_.each(b,function(a,c){if("id"==c||"boolean"==typeof a||null===a)e[c]=b[c],j.push(c)});_.each(j,function(a){delete f[a]});
