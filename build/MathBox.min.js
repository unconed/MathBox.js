...
b)}};MathBox.Ticks=function(a,b,c,d,e,f){var g=(b-a)/(c||10),d=d||1,c=d==\u03c0?2:10,h=d*((f||0)+Math.pow(c,Math.floor(Math.log(g/d)/Math.log(c)))),d=_.map(c==\u03c0?[1]:[5,1,0.5],function(a){return h*a}),i=_.reduce(d,function(a,b){return Math.abs(b-g)<Math.abs(a-g)?b:a},h),e=+!e,a=(Math.ceil(a/i)+e)*i,b=(Math.floor(b/i)-e)*i,c=Math.ceil((b-a)/i)+1,j=[];_.loop(c,function(b){j.push(a+b*i)});return j};MathBox.TicksLog=function(){};
...
MathBox.Bezier.prototype=_.extend(new MathBox.Curve(null),{defaults:function(){return{n:64,domain:[0,1],data:null,order:3,expression:function(){return 0},live:!0,points:!1,line:!0,style:{}}},type:function(){return"bezier"},calculate:function(){var a=this.vertices,b=this.get(),c=b.domain,d=b.data,e=b.order,f=b.n;if(1>e||3<e)throw"Bezier curve order must be 1, 2 or 3.";var g=[],h;_.loop(e+1,function(a){h=d&&void 0!==d[a]?d[a]:b.expression.call(this,a,a);h instanceof Array||(h=[j,h,0]);h=h.concat([0,
0,0]);g.push(new THREE.Vector3(h[0],h[1],h[2]))}.bind(this));var i={bezierPoints:g},j=c[0],l=(c[1]-j)/(f-1);_.loop(f,function(b){a[b].set(j,0,0);j+=l});c={uniforms:i,shaders:{position:function(a,b){a.snippet("bezier"+e).snippet("mathTransform");b.viewport(a)}}};this.line.set(c);this.points.set(c)}});MathBox.Primitive.types.bezier=MathBox.Bezier;MathBox.Axis=function(a){null!==a&&MathBox.Primitive.call(this,a)};
MathBox.Axis.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{axis:0,offset:[0,0,0],n:2,labels:!1,ticks:10,tickBase:1,arrow:!0,size:0.07,style:{lineWidth:4,color:new THREE.Color(7368816)},zero:!0}},renderables:function(){return[this.line,this.ticks,this.arrow,this.labels]},type:function(){return"axis"},adjust:function(a){var b=this.get(),c=b.axis,d=b.offset,e=b.arrow,f=b.labels,g=b.ticks,h=b.tickBase,i=b.n,j=this.points,l=this.labelPoints,b=this.labelTangent,k=this.tickPoints,
m=this.tickSigns,q=[0,0,0],r=new THREE.Vector3;new THREE.Vector4;var a=a.axis(c),s=a[0],a=a[1],v=(a-s)/(i-1);r.set.apply(r,d);_.loop(i,function(a){q[c]=s+a*v;j[a].set.apply(j[a],q);j[a].addSelf(r)});this.arrow.show(e);d=this.scale=MathBox.Ticks(s,a,g,h,!0);this.ticks.show(!!g);if(g){g=Math.floor(k.length/2);d.length>g&&(d=d.slice(0,g));var g=[0,0,0],u;g[2==c?0:1-c]=0.01*(a-s);this.epsilon.set.apply(this.epsilon,g);q=[0,0,0];_.each(d,function(a,b){q[c]=a;var d=2*b;k[d].set.apply(k[d],q);k[d].addSelf(r);
m[d]=1;k[d+1].copy(k[d]);m[d+1]=-1;l[b].copy(k[d]);u=d+1});g=u+1;for(i=k.length;g<i;)k[g].copy(k[u]),m[g]=m[u],g++}q=[0,0,0];q[c]=1;b.set.apply(b,q);this.labels.show(!!f)},make:function(){var a=this.get(),b=a.n,c=a.ticks,d=this.style,e=this.points=[],f=this.labelPoints=[],g=this.labelTangent=new THREE.Vector3,h=this.tickPoints=[],i=this.tickSigns=[],j=this.epsilon=new THREE.Vector3;_.loop(b,function(){e.push(new THREE.Vector3)});_.loop(4*c,function(){f.push(new THREE.Vector3)});_.loop(8*c,function(){h.push(new THREE.Vector3);
i.push(1)});var c={dynamic:!0,size:a.size,offset:0.5},l={dynamic:!0,size:0.2*a.size},k=function(b){b=this.scale[b];return 0==b&&!a.zero?"":b}.bind(this);this.line=new MathBox.Renderable.Mesh(e,{dynamic:!0,type:"line"},d);this.arrow=new MathBox.Renderable.ArrowHead(e[b-2],e[b-1],c,d);this.ticks=new MathBox.Renderable.Ticks(h,i,j,l,d);this.labels=new MathBox.Renderable.Labels(f,g,k,{dynamic:!0},d)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};
...
e.push(new THREE.Vector3);e.push(new THREE.Vector3);var a=new MathBox.Renderable.ArrowHead(e[i++],e[i++],h,b);f.push(a)});this.line=new MathBox.Renderable.Mesh(d,g,b);f.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.points,d=this.get(),e=d.data,f=d.n,g=d.size,h=new THREE.Vector3(1,1,1),i=new THREE.Vector3;if(a){var j=a.transform.elements,a=g/2/Math.abs(j[0]),l=g/2/Math.abs(j[5]),g=g/2/Math.abs(j[10]);h.set(a,l,g)}var k=0,m=0;_.loop(2*f,function(a){p=e&&void 0!==
e[a]?e[a]:d.expression.call(this,m,k);p instanceof Array||(p=[a,p,0]);p=p.concat([0,0,0]);c[a].set.apply(c[a],p);b[a].set.apply(b[a],p);if(1==a%2){i.sub(b[a],b[a-1]);i.x=Math.abs(i.x);i.y=Math.abs(i.y);i.z=Math.abs(i.z);var f=i.lengthManhattan(),f=1-i.dot(h)/f/i.length();i.sub(b[a],b[a-1]);i.multiplyScalar(f);b[a].add(b[a-1],i)}m=k?m+1:m;k=(k+1)%2}.bind(this))}});MathBox.Primitive.types.vector=MathBox.Vector;MathBox.Surface=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
c[1],function(){e[0].push(new THREE.Vector3);e[1].push(new THREE.Vector3)})}this.calculate()},calculate:function(){var a=this.vertices,b=this.tangents,c=this.get(),d=c.data,e=c.domain,f=c.n;"number"==typeof f&&(f=[f,f]);var g=e[0][0],h=e[1][0],i=(e[0][1]-g)/(f[0]-1),j=(e[1][1]-h)/(f[1]-1),l,k=0;_.loop(f[1],function(b){g=e[0][0];_.loop(f[0],function(e){l=d&&void 0!==d[b]&&void 0!==d[b][e]?d[b][e]:c.expression.call(this,g,h,e,b,k);l instanceof Array||(l=[g,l,h]);l=l.concat([0,0,0]);a[k].set.apply(a[k],
l);g+=i;k++}.bind(this));h+=j}.bind(this));if(c.shaded){var k=0,h=e[1][0],m=f[0];_.loop(f[1],function(c){g=e[0][0];var d=c?c-1:0,l=Math.min(f[1]-1,c+1);_.loop(f[0],function(e){var h=e?e-1:0,j=Math.min(f[0]-1,e+1),t=a[e+c*m];j==e?b[0][k].sub(t,a[h+c*m],t).addSelf(t):b[0][k].copy(a[j+c*m]);l==c?b[1][k].sub(t,a[e+d*m]).addSelf(t):b[1][k].copy(a[e+l*m]);g+=i;k++});h+=j});this.line.set("attributes",{positionDU:b[0],positionDV:b[1]});this.mesh.set("attributes",{positionDU:b[0],positionDV:b[1]})}}});
...
i[1][2],i[2][2],i[3][2],i[4][2],i[5][2],i[6][2],i[7][2],i[8][2],i[9][2],i[10][2],i[11][2],i[12][2],i[13][2],i[14][2],i[15][2]);var j=this.coefficients;this.matrixX.multiplySelf(j).transpose().multiplySelf(j);this.matrixY.multiplySelf(j).transpose().multiplySelf(j);this.matrixZ.multiplySelf(j).transpose().multiplySelf(j);var j={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},l=c[0][0],k=c[1][0],m=(c[0][1]-l)/(g[0]-1),q=(c[1][1]-k)/(g[1]-1),r=0;_.loop(g[1],function(){l=
c[0][0];_.loop(g[0],function(){a[r].set(l,k,0);l+=m;r++}.bind(this));k+=q}.bind(this));j={uniforms:j,shaders:{position:function(a,b){f?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(j);this.line.set(j);this.points.set(j)}});MathBox.Primitive.types.bezierSurface=MathBox.BezierSurface;
...
focus=this._uniforms.polarFocus;1==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspect,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,d=b.scale,e=b.polar,f=b.fold,b=b.power,g=1,h=c[0][0],i=c[1][0],j=c[2][0],l=c[0][1]-h,k=c[1][1]-i,c=c[2][1]-j,m=d[0],q=d[1],d=d[2],r=l+(k-l)*e,g=r/m/(k/q),s=[r/(2*m),0,0,h+l/2,0,k/(2*q),0,i+k/2,0,0,c/(2*d),j+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*m/r,0,0,-(2*h+l)*m/l,0,2*q/k,0,-(2*i+k)*q/k,0,0,2*d/
