...
MathBox.Sprite?this.overlay.add(a):THREE.Object3D.prototype.add.call(this,a);this._add(a);b=this.animateOptions(b);var c=a.style.get("opacity");b&&0<c&&(a.style.set("opacity",0),this.animator.animate(a.style,{opacity:c},b));return this},remove:function(a,b){if(a instanceof THREE.Object3D)return a instanceof MathBox.Sprite?this.overlay.remove(a):THREE.Object3D.prototype.remove.call(this,a);if("string"==typeof a)return _.each(this.select(a),function(a){this.remove(a,b)}.bind(this));var c=function(){this._remove(a)}.bind(this);
...
MathBox.Vector.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{n:1,data:null,arrow:!0,expression:function(){return 0},live:!0,style:{},size:0.07}},type:function(){return"vector"},renderables:function(){return this.render},adjust:function(a){var b=this.get();this.calculate(a);_.each(this.arrows,function(a){a.show(b.arrow)})},make:function(){var a=this.get(),b=a.arrow,c=this.style,d=a.n,e=this.vertices=[],f=this.points=[],j=this.render=[],g=this.arrows=[],h={dynamic:a.live,
type:"line",strip:!1},k={size:a.size},m=0;_.loop(d,function(){e.push(new THREE.Vector3);e.push(new THREE.Vector3);f.push(new THREE.Vector3);f.push(new THREE.Vector3);if(b){var a=new MathBox.Renderable.ArrowHead(f[m++],f[m++],k,c);j.push(a);g.push(a)}});this.line=new MathBox.Renderable.Mesh(e,h,c);j.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.arrows,d=this.points,e=this.get(),f=e.data,j=e.arrow,g=e.n,h=e.size,k=this.style.get("mathScale"),m=new THREE.Vector3,
l=new THREE.Vector3,s=0,r=0;_.loop(2*g,function(g){p=f&&void 0!==f[g]?f[g]:e.expression.call(this,r,s);p instanceof Array||(p=[g,p,0]);p=p.concat([0,0,0]);d[g].set.apply(d[g],p);b[g].set.apply(b[g],p);if(a&&j&&1==g%2){l.copy(b[g]);m.copy(b[g-1]);a.to(l);a.to(m);l.subSelf(m).multiplySelf(k);var t=l.length(),u=Math.min(1,0.5*t/h),u=(1-(1-u)*(1-u))*h;l.normalize().multiplyScalar(t-u).divideSelf(k).addSelf(m);a.from(l);b[g].copy(l);c[r].set({size:u})}r=s?r+1:r;s=(s+1)%2}.bind(this))}});
