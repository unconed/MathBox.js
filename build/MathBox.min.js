...
d=a.distance,e=a.class_name,a=this.style,f=this.labelTangent=new THREE.Vector3,h=this.labelPoint=new THREE.Vector3,d={dynamic:!0,distance:d,class_name:e};h.set.apply(h,b);b=function(a){return c}.bind(this);this.labels=new MathBox.Renderable.Labels([h],f,b,d,a)}});MathBox.Label.validateArgs=function(a){return a};MathBox.Primitive.types.label=MathBox.Label;
