...
0,0]);g.push(new THREE.Vector3(i[0],i[1],i[2]))}.bind(this));var h={bezierPoints:g},j=c[0],l=(c[1]-j)/(f-1);_.loop(f,function(b){a[b].set(j,0,0);j+=l});c={uniforms:h,shaders:{position:function(a,b){a.snippet("bezier"+e).snippet("mathTransform");b.viewport(a)}}};this.line.set(c);this.points.set(c)}});MathBox.Primitive.types.bezier=MathBox.Bezier;MathBox.Axis=function(a){null!==a&&MathBox.Primitive.call(this,a)};
MathBox.Axis.prototype=_.extend(new MathBox.Primitive(null),{defaults:function(){return{axis:0,offset:[0,0,0],n:2,labels:!1,distance:15,ticks:10,tickBase:1,arrow:!0,size:0.07,style:{lineWidth:4,color:new THREE.Color(7368816)},zero:!0}},renderables:function(){return[this.line,this.ticks,this.arrow,this.labels]},type:function(){return"axis"},adjust:function(a){var b=this.get(),c=b.axis,d=b.offset,e=b.arrow,f=b.labels,g=b.ticks,i=b.tickBase,h=b.n,j=this.points,l=this.labelPoints,b=this.labelTangent,
k=this.tickPoints,q=this.tickSigns,m=[0,0,0],r=new THREE.Vector3;new THREE.Vector4;var a=a.axis(c),s=a[0],a=a[1],u=(a-s)/(h-1);r.set.apply(r,d);_.loop(h,function(a){m[c]=s+a*u;j[a].set.apply(j[a],m);j[a].addSelf(r)});this.arrow.show(e);d=this.scale=MathBox.Ticks(s,a,g,i,!0);this.ticks.show(!!g);if(g){g=Math.floor(k.length/2);d.length>g&&(d=d.slice(0,g));var g=[0,0,0],t;g[2==c?0:1-c]=0.01*(a-s);this.epsilon.set.apply(this.epsilon,g);m=[0,0,0];_.each(d,function(a,b){m[c]=a;var d=2*b;k[d].set.apply(k[d],
m);k[d].addSelf(r);q[d]=1;k[d+1].copy(k[d]);q[d+1]=-1;l[b].copy(k[d]);t=d+1});g=t+1;for(h=k.length;g<h;)k[g].copy(k[t]),q[g]=q[t],g++}m=[0,0,0];m[c]=1;b.set.apply(b,m);this.labels.show(!!f)},make:function(){var a=this.get(),b=a.n,c=a.ticks,d=this.style,e=this.points=[],f=this.labelPoints=[],g=this.labelTangent=new THREE.Vector3,i=this.tickPoints=[],h=this.tickSigns=[],j=this.epsilon=new THREE.Vector3;_.loop(b,function(){e.push(new THREE.Vector3)});_.loop(4*c,function(){f.push(new THREE.Vector3)});
_.loop(8*c,function(){i.push(new THREE.Vector3);h.push(1)});var c={dynamic:!0,size:a.size,offset:0.5},l={dynamic:!0,size:0.2*a.size},k={dynamic:!0,distance:a.distance},q=function(b){b=this.scale[b];return 0==b&&!a.zero?"":b}.bind(this);this.line=new MathBox.Renderable.Mesh(e,{dynamic:!0,type:"line"},d);this.arrow=new MathBox.Renderable.ArrowHead(e[b-2],e[b-1],c,d);this.ticks=new MathBox.Renderable.Ticks(i,h,j,l,d);this.labels=new MathBox.Renderable.Labels(f,g,q,k,d)}});
...
1,function(){a[g].set.apply(a[g],f);g++;f[c.axis]+=c.inv;a[g].set.apply(a[g],f);g++})});d=Math.max(0,g-1);for(i=a.length;g<i;)a[g++].copy(a[d])}var c=this.get(),d=c.axis,e=c.ticks,f=c.tickBase,g=c.n,i=c.show,h=c.offset,c=this.points,j=this.limit,l=[];"number"==typeof g&&(g=[g,g]);_.each(d,function(b,c){var d=a.axis(b);l.push({axis:b,min:d[0],max:d[1],inv:(d[1]-d[0])/(g[c]-1),ticks:e[c],tickBase:f[c]})});this.lines[0].show(i[0]);this.lines[1].show(i[1]);i[0]&&b(c[0],l[1],l[0],j[0],g[0]);i[1]&&b(c[1],
l[0],l[1],j[1],g[1])},make:function(){var a=this.get(),b=a.ticks,c=a.n,d=this.points=[[],[]],a=this.style;"number"==typeof c&&(c=[c,c]);var e=this.limit=[0,0];_.each(b,function(a,b){b=1-b;e[b]=4*a;_.loop(2*e[b]*(c[b]-1),function(){d[b].push(new THREE.Vector3)})});this.lines=[];this.lines.push(new MathBox.Renderable.Mesh(d[0],{type:"line",strip:!1,dynamic:!0},a));this.lines.push(new MathBox.Renderable.Mesh(d[1],{type:"line",strip:!1,dynamic:!0},a))}});MathBox.Primitive.types.grid=MathBox.Grid;
...
strip:!1},h={size:a.size},j=0;_.loop(c,function(){d.push(new THREE.Vector3);d.push(new THREE.Vector3);e.push(new THREE.Vector3);e.push(new THREE.Vector3);var a=new MathBox.Renderable.ArrowHead(e[j++],e[j++],h,b);f.push(a);g.push(a)});this.line=new MathBox.Renderable.Mesh(d,i,b);f.push(this.line);this.calculate()},calculate:function(a){var b=this.vertices,c=this.points,d=this.get(),e=d.data,f=d.arrow,g=d.n,i=d.size,h=new THREE.Vector3,j=new THREE.Vector3,l=0,k=0;_.loop(2*g,function(g){p=e&&void 0!==
e[g]?e[g]:d.expression.call(this,k,l);p instanceof Array||(p=[g,p,0]);p=p.concat([0,0,0]);c[g].set.apply(c[g],p);b[g].set.apply(b[g],p);if(a&&f&&1==g%2){j.copy(b[g]);h.copy(b[g-1]);a.to(j);a.to(h);j.subSelf(h);var m=j.length()-i;j.normalize().multiplyScalar(m).addSelf(h);a.from(j);b[g].copy(j)}k=l?k+1:k;l=(l+1)%2}.bind(this))}});MathBox.Primitive.types.vector=MathBox.Vector;MathBox.Surface=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
c[1],function(){e[0].push(new THREE.Vector3);e[1].push(new THREE.Vector3)})}this.calculate()},calculate:function(){var a=this.vertices,b=this.tangents,c=this.get(),d=c.data,e=c.domain,f=c.n,g=c.flipSided,i=g?1:0,g=g?0:1;"number"==typeof f&&(f=[f,f]);var h=e[0][0],j=e[1][0],l=(e[0][1]-h)/(f[0]-1),k=(e[1][1]-j)/(f[1]-1),q,m=0;_.loop(f[1],function(b){h=e[0][0];_.loop(f[0],function(e){q=d&&void 0!==d[b]&&void 0!==d[b][e]?d[b][e]:c.expression.call(this,h,j,e,b,m);q instanceof Array||(q=[h,q,j]);q=q.concat([0,
0,0]);a[m].set.apply(a[m],q);h+=l;m++}.bind(this));j+=k}.bind(this));if(c.shaded){var m=0,j=e[1][0],r=f[0];_.loop(f[1],function(c){h=e[0][0];var d=c?c-1:0,g=Math.min(f[1]-1,c+1);_.loop(f[0],function(e){var i=e?e-1:0,j=Math.min(f[0]-1,e+1),k=a[e+c*r];j==e?b[0][m].sub(k,a[i+c*r],k).addSelf(k):b[0][m].copy(a[j+c*r]);g==c?b[1][m].sub(k,a[e+d*r]).addSelf(k):b[1][m].copy(a[e+g*r]);h+=l;m++});j+=k});this.line.set("attributes",{positionDU:b[i],positionDV:b[g]});this.mesh.set("attributes",{positionDU:b[i],
...
h[1][2],h[2][2],h[3][2],h[4][2],h[5][2],h[6][2],h[7][2],h[8][2],h[9][2],h[10][2],h[11][2],h[12][2],h[13][2],h[14][2],h[15][2]);var j=this.coefficients;this.matrixX.multiplySelf(j).transpose().multiplySelf(j);this.matrixY.multiplySelf(j).transpose().multiplySelf(j);this.matrixZ.multiplySelf(j).transpose().multiplySelf(j);var j={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},l=c[0][0],k=c[1][0],q=(c[0][1]-l)/(g[0]-1),m=(c[1][1]-k)/(g[1]-1),r=0;_.loop(g[1],function(){l=
c[0][0];_.loop(g[0],function(){a[r].set(l,k,0);l+=q;r++}.bind(this));k+=m}.bind(this));j={uniforms:j,shaders:{position:function(a,b){f?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(j);this.line.set(j);this.points.set(j)}});MathBox.Primitive.types.bezierSurface=MathBox.BezierSurface;
...
d.className="mathbox-wrap";d.style.position="relative";d.style.display="inline-block";d.style.left="-50%";d.style.top="-.5em";b.push(i);e.add(i)})},adjust:function(a){var b=this.get(),c=this.points,d=this.callback,e=this.style,f=window.MathJax&&MathJax.Hub;_.each(this.sprites,function(g,i){g.position.copy(c[i]);a.to(g.position);g.distance=b.distance;g.element.style.opacity=e.get("opacity");var h="";if(d&&(h=d(i),void 0===h&&(h=""),+h==h)){var j=+h;if(0!=j)var h=0>j?-1:1,j=Math.abs(j),l=Math.pow(10,
1-Math.floor(Math.log(j)/Math.log(10))),h=j=h*Math.round(l*j)/l}g.content!==h&&(j=g.element.children[0],g.content=h,f?(j.innerHTML="\\("+h+"\\)",MathJax.Hub.queue.Push(["Typeset",MathJax.Hub,j])):j.innerHTML=h)});MathBox.Renderable.prototype.adjust.call(this,a)}});MathBox.Viewport=function(a){if(null!==a){var b=this.defaults(),a=_.extend(b,a||{});this.set(a);this.singleton="viewport";this._uniforms={}}};
...
focus=this._uniforms.polarFocus;1==a&&0<alpha&&(max=Math.max(Math.abs(max),Math.abs(min)),min=Math.max(-focus/aspect+0.001,min));return[min,max]},update:function(a){var b=this.get(),c=b.range,d=b.scale,e=b.polar,f=b.fold,b=b.power,g=1,i=c[0][0],h=c[1][0],j=c[2][0],l=c[0][1]-i,k=c[1][1]-h,c=c[2][1]-j,q=d[0],m=d[1],d=d[2],r=l+(k-l)*e,g=r/q/(k/m),s=[r/(2*q),0,0,i+l/2,0,k/(2*m),0,h+k/2,0,0,c/(2*d),j+c/2,0,0,0,1];this.transform.set.apply(this.transform,[2*q/r,0,0,-(2*i+l)*q/l,0,2*m/k,0,-(2*h+k)*m/k,0,
